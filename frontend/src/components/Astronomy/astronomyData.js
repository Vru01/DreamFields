// astronomyData.js
export const astronomyData = {
    title: "Astronomy",
    definition: "The scientific study of celestial objects, space, and the universe as a whole.",
    description: "Astronomy is a branch of science that deals with the study of celestial bodies such as stars, planets, comets, galaxies, and the phenomena that occur outside the Earth's atmosphere. It aims to understand the formation, evolution, and future of the universe.",
    Funfacts : [
    ...
    images: [
      {
        url: "https://example.com/images/astronomy1.jpg",
        description: "An image of a galaxy showing millions of stars."
      },
      {
        url: "https://example.com/images/astronomy2.jpg",
        description: "A close-up image of the surface of Mars."
      }
    ],
    jobRelatedCards: [
      {
        title: "Astronomer",
        description: "Astronomers study celestial objects and phenomena, including planets, stars, and galaxies. They use telescopes and other instruments to collect data and analyze it to understand how the universe works."
      },
      {
        title: "Astrophysicist",
        description: "Astrophysicists explore the physical properties of celestial bodies and use physics to understand phenomena such as black holes, neutron stars, and cosmic radiation."
      },
      {
        title: "Space Scientist",
        description: "Space scientists study the outer space environment, focusing on the solar system, space weather, and the potential for human exploration of other planets."
      },
      {
        title: "Planetary Scientist",
        description: "Planetary scientists focus on understanding the formation and characteristics of planets, moons, and other celestial bodies, including their atmospheres and geological features."
      }
    ],
    paths: [
      {
        name: "Educational Pathway",
        description: "Students interested in Astronomy can pursue courses in physics, mathematics, and computer science. At the undergraduate level, B.Sc. in Physics or Astronomy is recommended. Further studies can include a Master's degree in Astronomy, Astrophysics, or Space Science, followed by a PhD for research positions.",
        colleges: [
      ...
      },
      {
        ...
        description: "To pursue a career in Astronomy, students should have a strong background in physics and mathematics. Skills in programming, data analysis, and problem-solving are also essential."
      }
    ],
    quiz: [
      {
